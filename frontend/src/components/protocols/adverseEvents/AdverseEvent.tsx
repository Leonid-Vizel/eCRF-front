...
const AdverseEvent = ({data, index, anchorClassname, setIsColorRed, setIsOptionsColorRed, isOptionsColorRed}) => {
    // console.log(data)
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.AdverseEventsRegisteredCondition.Color} refProps={ref1} element={
                                <select
                                    ref={ref1}
                                    name="adverseEventsRegisteredCondition"
                                    value={adverse.adverseEventsRegisteredCondition}
