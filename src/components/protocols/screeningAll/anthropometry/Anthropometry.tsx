...
const Anthropometry = ({data, index, anchorClassname, setIsColorRed, setIsOptionsColorRed, isOptionsColorRed}) => {
            ...
            <div className="section">
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.AnthropometricDataBeenMeasuredCondition.Color} refProps={ref1} element={
                                <select
                                    ref={ref1}
                                    name="data_been_measured"
                                    value={anthropometry.data_been_measured}
                            ...
                            } index={index} fieldName={'data_been_measured'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        />
                        <div className="label-select-block">
                            <StateControl color={data && data?.ReasonIfNotCondition.Color} refProps={ref2} element={
                                <input
                                    type="text"
                                    ref={ref2}
                                    name="if_not"
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        />
                        <div className="label-select-block">
                            <StateControl color={data && data?.DateOfStartMeasuredCondition.Color} refProps={ref3} element={
                                <input
                                    type="date"
                                    ref={ref3}
                                    name="date_of_start"
                                    ...
                                    className='exact-protocol-select'
                                />
                            } index={index} fieldName={'date_of_start'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        />
                        <div className="label-select-block">
                            <StateControl color={data && data?.WeightOfBodyCondition.Color} refProps={ref4} element={
                                <input
                                    type="text"
                                    ref={ref4}
                                    name="weight"
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        />
                        <div className="label-select-block">
                            <StateControl color={data && data?.HeightOfBodyCondition.Color} refProps={5} element={
                                <input
                                    type="text"
                                    ref={ref5}
                                    name="height"
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        />
                        <div className="label-select-block">
                            <StateControl color={data && data?.IndexWeigthOfBodyCondition.Color} refProps={ref6} element={
                                <input
                                    ref={ref6}
                                    type="text"
                                    name="index"
