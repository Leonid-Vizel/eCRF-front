...
const Ending = ({data, index, anchorClassname, setIsColorRed, setIsOptionsColorRed, isOptionsColorRed}) => {
            ...
            <div className="section">
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.VolunteerEligibleCondition.Color} refProps={refEnding1} element={
                                <select
                                    ref={refEnding1}
                                    name="volunteereligible"
                                    value={ending.volunteereligible}
                            ...
                            } index={index} fieldName={'volunteereligible'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.NoExclusionCriteriaCondition.Color} refProps={refEnding2} element={
                                <select
                                    ref={refEnding2}
                                    name="noexclusioncriteria"
                                    value={ending.noexclusioncriteria}
                            ...
                            } index={index} fieldName={'noexclusioncriteria'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.InformedOfTheRestrictionsCondition.Color} refProps={refEnding3} element={
                                <select
                                    ref={refEnding3}
                                    name="informedoftherestrictions"
                                    value={ending.informedoftherestrictions}
                            ...
                            } index={index} fieldName={'informedoftherestrictions'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.VolunteerIncludedCondition.Color} refProps={refEnding4} element={
                                <select
                                    name="volunteerincluded"
                                    value={ending.volunteerincluded}
                                    onChange={handleEnding}
                            ...
                            } index={index} fieldName={'volunteerincluded'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        />
                        <div className="label-select-block">
                            <StateControl color={data && data?.ReasonIfNotCondition.Color} refProps={refEnding5} element={
                                <input
                                    type="text"
                                    name="reasonifnot"
                                    value={ending.reasonifnot}
                                    ...
                                    placeholder={data && data.ReasonIfNotCondition.ReasonIfNot}
                                />
                            } index={index} fieldName={'reasonifnot'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        />
                        <div className="label-select-block">
                            <StateControl color={data && data?.CommentCondition.Color} refProps={refEnding6} element={
                                <input
                                    type="text"
                                    ref={refEnding6}
                                    name="commentvalue"
                                    ...
                                    placeholder={data && data.CommentCondition.CommentValue}
                                />
                            } index={index} fieldName={'commentvalue'}/>
                        </div>
                    </div>
                </label>
            </div>
