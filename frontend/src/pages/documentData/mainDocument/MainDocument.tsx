...
const MainDocument = () => {
    ...
    const raceItems: InputBlockItem[] =
        formData.Race != 3
            ? [
                  {
                      inputTitle: 'Раса',
    ...
    const handleInputChange = (event, additionalParam = null) => {
        ...
        const name =
            additionalParam !== null ? additionalParam : event.target.name;
    ...
    const handleInputTwelveChange = (index, field, value) => {
        setFormData((prevFormData) => {
            ...
            newFormData = {
                ...newFormData,
                Deseases: newFormData.Deseases.map((item, i) =>
                    i === index
                        ? {
                              ...item,
                              [field]: value,
    ...
    const handleInputTwentyChange = (index, field, value) => {
        setFormData((prevFormData) => {
            ...
            newFormData = {
                ...newFormData,
                Diagnosis: newFormData.Diagnosis.map((item, i) =>
    ...
    const handleInputPhonesChange = (index, field, value) => {
        setFormData((prevFormData) => {
            ...
            newFormData = {
                ...newFormData,
                Phones: newFormData.Phones.map((item, i) =>
                    i === index ? { ...item, [field]: value } : item
                ),
            };
            return newFormData;
            ...
            formData?.Phones.map((item, index) => (
                ...
                >
                    <div className='document-input-block Phones'>
                        ...
                        <label
                            className={
                                'document-input-block-label-sm Phones-label'
                            }
                            ...
                            <Autosuggest
                                ...
                                inputProps={{
                                    onChange: (event, { newValue }) => {
                                        return handleInputTwelveChange(
                                            index,
                                            'Code',
                                            newValue
                                        );
