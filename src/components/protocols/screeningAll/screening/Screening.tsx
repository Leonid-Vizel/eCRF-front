...
const Screening = ({data, index, anchorClassname, setIsColorRed, setIsOptionsColorRed, isOptionsColorRed}) => {
            ...
            <div className="section">
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.SignedCondition.Color} element={
                                <select
                                    ref={ref1}
                                    name="signed"
                                    value={informedConsent.signed}
                            ...
                            } refProps={ref1} index={index} fieldName={'signed'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        />
                        <div className="label-select-block">
                            <StateControl color={data && data?.DateOfSignCondition.Color} refProps={ref2} element={
                                <input
                                    type="date"
                                    ref={ref2}
                                    name="date_of_sign"
                                    ...
                                    className='exact-protocol-select'
                                />
                            } index={index} fieldName={'date_of_sign'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        />
                        <div className="label-select-block">
                            <StateControl color={data && data?.TimeOfSignCondition.Color} refProps={ref3} element={
                                <input
                                    type="text"
                                    ref={ref3}
                                    name="time_of_sign"
                                    ...
                                    className='exact-protocol-select'
                                />
                            } index={index} fieldName={'time_of_sign'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.ReceivedAnInsurancePolicyCondition.Color} refProps={ref4} element={
                                <select
                                    name="original"
                                    ref={ref4}
                                    value={informedConsent.original}
                            ...
                            } index={index} fieldName={'original'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.ReceivedAnInformaionConsentCondition.Color} refProps={ref5} element={
                                <select
                                    name="consent"
                                    ref={ref5}
                                    value={informedConsent.consent}
