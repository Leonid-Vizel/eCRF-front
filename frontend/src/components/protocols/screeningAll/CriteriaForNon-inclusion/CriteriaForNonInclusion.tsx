...
const CriteriaForNonInclusion = ({data, index, anchorClassname, setIsColorRed, setIsOptionsColorRed, isOptionsColorRed}) => {
            ...
            <div className="section">
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.LackOfSignedInformedConsentCondition.Color} refProps={refNon1} element={
                                <select
                                    ref={refNon1}
                                    name="lackofsignedinformedconsent"
                                    value={criteriaForNonInclusion.lackofsignedinformedconsent}
                            ...
                            } index={index} fieldName={'lackofsignedinformedconsent'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.SteroidTherapyCondition.Color} refProps={refNon2} element={
                                <select
                                    ref={refNon2}
                                    name="steroidtherapy"
                                    onChange={handleCriteriaForNonInclusion}
                            ...
                            } index={index} fieldName={'steroidtherapy'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.TherapyWithImmunosuppressiveDrugsCondition.Color} refProps={refNon3} element={
                                <select
                                    ref={refNon3}
                                    name="therapywithimmunosuppressivedrugs"
                                    value={criteriaForNonInclusion.therapywithimmunosuppressivedrugs}
                            ...
                            } index={index} fieldName={'therapywithimmunosuppressivedrugs'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.FemaleSubjectsDuringPregnancyCondition.Color} refProps={refNon4} element={
                                <select
                                    ref={refNon4}
                                    name="femalesubjectsduringpregnancy"
                                    value={criteriaForNonInclusion.femalesubjectsduringpregnancy}
                            ...
                            } index={index} fieldName={'femalesubjectsduringpregnancy'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.StrokeInLessThanOneYearCondition.Color} refProps={refNon5} element={
                                <select
                                    ref={refNon5}
                                    name="strokeinlessthanoneyear"
                                    value={criteriaForNonInclusion.strokeinlessthanoneyear}
                            ...
                            } index={index} fieldName={'strokeinlessthanoneyear'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.ChronicSystemicInfectionsCondition.Color} refProps={refNon6} element={
                                <select
                                    ref={refNon6}
                                    name="chronicsystemicinfections"
                                    value={criteriaForNonInclusion.chronicsystemicinfections}
                            ...
                            } index={index} fieldName={'chronicsystemicinfections'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.AggravatedAllergicHistoryCondition.Color} refProps={refNon7} element={
                                <select
                                    ref={refNon7}
                                    name="aggravatedallergichistory"
                                    value={criteriaForNonInclusion.aggravatedallergichistory}
                            ...
                            } index={index} fieldName={'aggravatedallergichistory'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.PresenceOfAHistoryOfNeoplasmsCondition.Color} refProps={refNon8} element={
                                <select
                                    ref={refNon8}
                                    name="presenceofahistoryofneoplasms"
                                    value={criteriaForNonInclusion.presenceofahistoryofneoplasms}
                            ...
                            } index={index} fieldName={'presenceofahistoryofneoplasms'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.HistoryOfSplenectomyCondition.Color} refProps={refNon9} element={
                                <select
                                    ref={refNon9}
                                    name="historyofsplenectomy"
                                    value={criteriaForNonInclusion.historyofsplenectomy}
                            ...
                            } index={index} fieldName={'historyofsplenectomy'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.NeutropeniaCondition.Color} refProps={refNon10} element={
                                <select
                                    ref={refNon10}
                                    name="neutropenia"
                                    value={criteriaForNonInclusion.neutropenia}
                            ...
                            } index={index} fieldName={'neutropenia'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.SubjectsWithActiveSyphilisCondition.Color} refProps={refNon11} element={
                                <select
                                    ref={refNon11}
                                    name="subjectswithactivesyphilis"
                                    value={criteriaForNonInclusion.subjectswithactivesyphilis}
                            ...
                            } index={index} fieldName={'subjectswithactivesyphilis'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.AnorexiaCondition.Color} refProps={refNon12} element={
                                <select
                                    ref={refNon12}
                                    name="anorexia"
                                    value={criteriaForNonInclusion.anorexia}
                            ...
                            } index={index} fieldName={'anorexia'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.ExtensiveTattoosCondition.Color} refProps={refNon13} element={
                                <select
                                    ref={refNon13}
                                    name="extensivetattoos"
                                    value={criteriaForNonInclusion.extensivetattoos}
                            ...
                            } index={index} fieldName={'extensivetattoos'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.TakingNarcoticAndPsychostimulantDrugsCondition.Color} refProps={refNon14} element={
                                <select
                                    ref={refNon14}
                                    name="takingnarcoticandpsychostimulantdrugs"
                                    value={criteriaForNonInclusion.takingnarcoticandpsychostimulantdrugs}
                            ...
                            } index={index} fieldName={'takingnarcoticandpsychostimulantdrugs'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.SmokingMoretThanTenCigarettesADayCondition.Color} refProps={refNon15} element={
                                <select
                                    ref={refNon15}
                                    name="smokingmorethantencigarettesaday"
                                    value={criteriaForNonInclusion.smokingmorethantencigarettesaday}
                            ...
                            } index={index} fieldName={'smokingmorethantencigarettesaday'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.AlcoholIntakeCondition.Color} refProps={refNon16} element={
                                <select
                                    ref={refNon16}
                                    name="alcoholintake"
                                    value={criteriaForNonInclusion.alcoholintake}
                            ...
                            } index={index} fieldName={'alcoholintake'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.PlannedHospitalizationConditiont.Color} refProps={refNon17} element={
                                <select
                                    ref={refNon17}
                                    name="plannedhospitalization"
                                    value={criteriaForNonInclusion.plannedhospitalization}
                            ...
                            } index={index} fieldName={'plannedhospitalization'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.DonorBloodDonationCondition.Color} refProps={refNon18} element={
                                <select
                                    ref={refNon18}
                                    name="donorblooddonation"
                                    value={criteriaForNonInclusion.donorblooddonation}
                            ...
                            } index={index} fieldName={'donorblooddonation'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.SubjectParticipationInAnyOtherStudyCondition.Color} refProps={refNon19} element={
                                <select
                                    ref={refNon19}
                                    name="subjectparticipationinanyotherstudy"
                                    value={criteriaForNonInclusion.subjectparticipationinanyotherstudy}
                            ...
                            } index={index} fieldName={'subjectparticipationinanyotherstudy'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.AnyVaccinationInTheLastMonthCondition.Color} refProps={refNon20} element={
                                <select
                                    ref={refNon20}
                                    name="anyvaccinationinthelastmonth"
                                    value={criteriaForNonInclusion.anyvaccinationinthelastmonth}
                            ...
                            } index={index} fieldName={'anyvaccinationinthelastmonth'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.InabilityToReadInRussianCondition.Color} refProps={refNon21} element={
                                <select
                                    ref={refNon21}
                                    name="inabilitytoreadinrussian"
                                    value={criteriaForNonInclusion.inabilitytoreadinrussian}
                            ...
                            } index={index} fieldName={'inabilitytoreadinrussian'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.ResearchCenterStaffCondition.Color} refProps={refNon22} element={
                                <select
                                    ref={refNon22}
                                    name="researchcenterstaff"
                                    value={criteriaForNonInclusion.researchcenterstaff}
                            ...
                            } index={index} fieldName={'researchcenterstaff'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.AnyOtherStateOfTheSubjectOfTheStudyCondition.Color} refProps={refNon23} element={
                                <select
                                    ref={refNon23}
                                    name="anyotherstateofthesubjectofthestudy"
                                    value={criteriaForNonInclusion.anyotherstateofthesubjectofthestudy}
                            ...
                            } index={index} fieldName={'anyotherstateofthesubjectofthestudy'}/>
                        </div>
                    </div>
                </label>
            </div>
