...
const CriteriaForInclusion = ({data, index, anchorClassname, setIsColorRed, setIsOptionsColorRed, isOptionsColorRed}) => {
            ...
            <div className="section">
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.PresenceOfAnInformationPanelCondition.Color} refProps={ref1} element={
                                <select
                                    ref={ref1}
                                    name="presenceofaninformationpanel"
                                    value={criteriaForInclusion.presenceofaninformationpanel}
                            ...
                            } index={index} fieldName={'presenceofaninformationpanel'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.Aged18To55YearsCondition.Color} refProps={ref2} element={
                                <select
                                    ref={ref2}
                                    name="aged18to55years"
                                    value={criteriaForInclusion.aged18to55years}
                            ...
                            } index={index} fieldName={'aged18to55years'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.NegativeHIVTestResultCondition.Color} refProps={ref3} element={
                                <select
                                    ref={ref3}
                                    name="negativehivtestresult"
                                    value={criteriaForInclusion.negativehivtestresult}
                            ...
                            } index={index} fieldName={'negativehivtestresult'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.BodyMassIndexCondition.Color} refProps={ref4} element={
                                <select
                                    ref={ref4}
                                    name="bodymassindex"
                                    value={criteriaForInclusion.bodymassindex}
                            ...
                            } index={index} fieldName={'bodymassindex'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.AbsenceOfAcuteInfectiousDiseasesCondition.Color} refProps={ref5} element={
                                <select
                                    ref={ref5}
                                    name="absenceofacuteinfectiousdiseases"
                                    value={criteriaForInclusion.absenceofacuteinfectiousdiseases}
                            ...
                            } index={index} fieldName={'absenceofacuteinfectiousdiseases'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.ConsentToUseEffectiveMethodsOfContraceptionCondition.Color} refProps={ref6} element={
                                <select
                                    ref={ref6}
                                    name="consenttouseeffectivemethodsofcontraception"
                                    value={criteriaForInclusion.consenttouseeffectivemethodsofcontraception}
                            ...
                            } index={index} fieldName={'consenttouseeffectivemethodsofcontraception'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.NegativePregnancyTestCondition.Color} refProps={ref7} element={
                                <select
                                    ref={ref7}
                                    name="negativepregnancytest"
                                    value={criteriaForInclusion.negativepregnancytest}
                            ...
                            } index={index} fieldName={'negativepregnancytest'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.NegativeDrugTestCondition.Color} refProps={ref8} element={
                                <select
                                    ref={ref8}
                                    name="negativedrugtest"
                                    value={criteriaForInclusion.negativedrugtest}
                            ...
                            } index={index} fieldName={'negativedrugtest'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.NegativeAlcoholTestCondition.Color} refProps={ref9} element={
                                <select
                                    ref={ref9}
                                    name="negativealcoholtest"
                                    value={criteriaForInclusion.negativealcoholtest}
                            ...
                            } index={index} fieldName={'negativealcoholtest'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.NoHistoryOfSeverePostVaccinationReactionsCondition.Color} refProps={ref10} element={
                                <select
                                    ref={ref10}
                                    name="nohistoryofseverepostvaccinationreactions"
                                    value={criteriaForInclusion.nohistoryofseverepostvaccinationreactions}
                            ...
                            } index={index} fieldName={'nohistoryofseverepostvaccinationreactions'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.IndicatorsBloodTestsAtScreeningWithinCondition.Color} refProps={11} element={
                                <select
                                    ref={ref11}
                                    name="indicatorsbloodtestsatscreeningwithin"
                                    value={criteriaForInclusion.indicatorsbloodtestsatscreeningwithin}
                            ...
                            } index={index} fieldName={'indicatorsbloodtestsatscreeningwithin'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.NoMyocardialChangesCondition.Color} refProps={ref12} element={
                                <select
                                    ref={ref12}
                                    name="nomyocardialchanges"
                                    value={criteriaForInclusion.nomyocardialchanges}
                            ...
                            } index={index} fieldName={'nomyocardialchanges'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.NegativeTestResultForCOVIDCondition.Color} refProps={ref13} element={
                                <select
                                    ref={ref13}
                                    name="negativetestresultforCOVID"
                                    value={criteriaForInclusion.negativetestresultforCOVID}
                            ...
                            } index={index} fieldName={'negativetestresultforCOVID'}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.NoContraindicationsToVaccinationCondition.Color} refProps={ref14} element={
                                <select
                                    ref={ref14}
                                    name="nocontraindicationstovaccination"
                                    value={criteriaForInclusion.nocontraindicationstovaccination}
                            ...
                            } index={index} fieldName={'nocontraindicationstovaccination'}/>
                        </div>
                    </div>
                </label>
            </div>
