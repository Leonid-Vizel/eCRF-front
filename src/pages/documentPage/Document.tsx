                ...
                <div className="document-block">
                    ...
                    <div className="document-top">
                        <div className="document-top-up">
                            <div className="document-top-up-left">
                                Протокол {item.protocolId ? item.protocolId : ''}, центр 01
                            </div>
                            <div className="document-top-up-right">
                                Доброволец <DocumentInput underlineLength={250} text={item.volunteer ? item.volunteer : ''}/>
                                Инициалы <DocumentInput underlineLength={50} text={item.initials ? item.initials : ''}/>
                            </div>
                        </div>
                        ...
                        <div className="document-top-bottom">
                            <div className="document-top-bottom-block">
                                ...
                                <div className="document-top-bottom-right">
                                    <p>Приложение №1 к приказу Министерства здравохранения Российской Федерации
                                        от 15 декабря 2014 г. N 834н</p>
                    ...
                    <div className="document-bottom">
                        ...
                        <div className="document-bottom-point">
                            1. <span>Дата заполнения медицинской карты:</span>
                            число <DocumentInput underlineLength={50} text={item.dateOfFill ? item.dateOfFill : ''}/>
                            месяц <DocumentInput underlineLength={100} text={item.monthOfFill ? item.monthOfFill : ''}/>
                            год <DocumentInput underlineLength={50} text={item.yearOfFill ? item.yearOfFill : ''}/>
                        </div>
                        <div className="document-bottom-point">
                            2. <span>Фамилия, имя, отчество</span>
                        ...
                        <div className="document-bottom-point">
                            ...
                            3. <span>Пол:</span> {item.sex}
                            <div className="document-bottom-point-one-line">
                                4. <span>Дата рождения:</span>
                                число <DocumentInput underlineLength={30} text={item.dateOfBirth ? item.dateOfBirth : ''}/>
                                месяц <DocumentInput underlineLength={70} text={item.monthOfBirth ? item.monthOfBirth : ''}/>
                                год <DocumentInput underlineLength={30} text={item.yearOfBirth ? item.yearOfBirth : ''}/>
                            </div>
                        </div>
                        <div className="document-bottom-point">
                            5. <span>Место регистрации:</span>
                            субъект Российской Федерации <DocumentInput underlineLength={100}
                                                                        text={item.subjectOfTheRussianFederation ? item.subjectOfTheRussianFederation : ''}/>
                        </div>
                        <div className="document-bottom-point">
                            район <DocumentInput underlineLength={50} text={item.district ? item.district : ''}/>
                            город <DocumentInput underlineLength={50} text={item.city ? item.city : ''}/>
                            населенный пункт <DocumentInput underlineLength={50} text={item.locality ? item.locality : ''}/>
                        </div>
                        <div className="document-bottom-point">
                            улица <DocumentInput underlineLength={50} text={item.street ? item.street : ''}/>
                            дом <DocumentInput underlineLength={50} text={item.house ? item.house : ''}/>
                            квартира <DocumentInput underlineLength={50} text={item.apart ? item.apart : ''}/>
                            тел <DocumentInput underlineLength={50} text={item.phNumber ? item.phNumber : ''}/>
                        </div>
                        <div className="document-bottom-point">
                            6. <span>Местность:</span> {item.terrain ? item.terrain : ''}
                        </div>
                        <div className="document-bottom-point">
                            7. <span>Полис ОМС:</span>
                            серия <DocumentInput underlineLength={100} text={item.OMSSeries ? item.OMSSeries : ''}/>
                            № <DocumentInput underlineLength={100} text={item.OMSNumber ? item.OMSNumber : ''}/>
                            <div className="document-bottom-point-one-line">
                                8. <span>СНИЛС</span> <DocumentInput underlineLength={100} text={item.snils ? item.snils : ''}/>
                            </div>
                        </div>
                        <div className="document-bottom-point">
                            9. <span>Наименование медицинской организации:</span>
                            <DocumentInput underlineLength={300} text={item.medOrg ? item.medOrg : ''}/>
                        </div>
                        <div className="document-bottom-point">
                            10. <span>Код категории льготы</span>
                            <DocumentInput underlineLength={50} text={item.benefitsCategoryCode ? item.benefitsCategoryCode : ''}/>
                            <div className="document-bottom-point-one-line">
                                11. <span>Документ</span> <DocumentInput underlineLength={100} text={item.docsPassport ? item.docsPassport : ''}/> :
                                серия <DocumentInput underlineLength={50} text={item.passportSeries ? item.passportSeries : ''}/>
                        ...
                        <div className="document-bottom-point">
                            13. <span>Семейное положение:</span>
                        ...
                        <div className="document-bottom-point">
                            14. <span className='document-bottom-point-span'>Образование:</span>
                        ...
                        {/*</div>*/}
                        <div className="document-bottom-point">
                            24. <span>Записи врачей-специалистов: </span>
                            Дата осмотра <DocumentInput underlineLength={100} text={item.dateOfView ? item.dateOfView : ''}/> на приеме, на
                            дому, в фельдшерско-
                        </div>
                        <div className="document-bottom-point">
