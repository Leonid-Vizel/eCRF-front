...
const StateControl = ({
  color, element, refProps, fieldName, index,
}) => {
  switch (color) {
    case 0: {
      return (
    ...
    case 2: {
      return (
        <div className="case-0">
          <CircleNoDropDown status="success" />
          <CircleNoDropDown status="success" />
          <Circle status="pending" element={element} refProps={refProps} fieldName={fieldName} index={index} isThird />
        </div>
      );
    }
    case 3: {
    ...
    case 5: {
      return (
        <div className="case-0">
          <CircleNoDropDown status="success" />
          <CircleNoDropDown status="success" />
          <Circle status="error" element={element} refProps={refProps} fieldName={fieldName} index={index} isThird />
        </div>
      );
    }
  }
