            ...
            if (index === 0) {
              return (
                <div className="exact-journal-update-left" key={index}>
                  ...
                  <input className="disabled" type="text" disabled placeholder="Название протокола" value={item[0].Value} />
                  <span>Роль</span>
                  <input
                    className="disabled"
                    type="text"
                  ...
                  />
                  <span>ID центра</span>
                  <input className="disabled" type="text" disabled placeholder="Центр к которому прикреплен протокол" value={item[2].Value} />
                  <span>Email</span>
                  <input className="disabled" type="text" disabled placeholder="Центр к которому прикреплен протокол" value={item[3].Value} />
                  <span>Имя</span>
                  <input className="disabled" type="text" disabled placeholder="Центр к которому прикреплен протокол" value={item[4].Value} />
                  <span>Пароль</span>
                  <input className="disabled" type="text" disabled placeholder="Центр к которому прикреплен протокол" value={item[5].Value} />
                </div>
              );
            } if (index === 1) {
              return (
                <React.Fragment key={index}>
                  ...
                  <div className="exact-journal-update-left">
                    ...
                    <input className="disabled" type="text" disabled placeholder="Название протокола" value={item[0].Value} />
                    <span>Роль</span>
                    <input className="disabled" type="text" disabled placeholder="Статус протокола" value={UserRoleMap[item[3].Value]} />
                    <span>ID центра</span>
                    <input className="disabled" type="text" disabled placeholder="Центр к которому прикреплен протокол" value={item[4].Value} />
                    <span>Email</span>
                    <input className="disabled" type="text" disabled placeholder="Центр к которому прикреплен протокол" value={item[1].Value} />
                    <span>Имя</span>
                    <input className="disabled" type="text" disabled placeholder="Центр к которому прикреплен протокол" value={item[2].Value} />
                    <span>Пароль</span>
                    <input className="disabled" type="text" disabled placeholder="Центр к которому прикреплен протокол" value={item[5].Value} />
            ...
            if (index === 0) {
              ...
              return (
                <React.Fragment key={index}>
                  ...
                  <div className="exact-journal-update-left">
                    <span>Название протокола</span>
                    <input className="disabled" type="text" disabled placeholder="Название протокола" value={item} />
                  </div>
                </React.Fragment>
              );
            }
