...
import NavbarAuth from "../../navbar_auth/NavbarAuth";
    ...
    return (
        <div className='navbar'>
            <div className="navbar-img">
                <img src="/logo.png" alt="" onClick={() => handleNavigate()}/>
            </div>
            ...
            >
                <span
                    ...
                    onMouseEnter={handleMouseEnter}
                >
                    ФИО: {cookiesData.cookieName}
                </span>
                {isHovered && (
                    <div className="navbar-modal" /*onMouseLeave={handleMouseLeave}*/>
