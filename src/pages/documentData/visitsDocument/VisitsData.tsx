      ...
      <div className="document-data">
        <div className="document-data-block">
          <div className="document-data-block-info">
            ...
            />
            <InputBlock
              title="Нервная система (моторная и сенсорная функции)"
            ...
            />
            <InputBlock
              title="Если да, опишите (подробно укажите событие, оценив тяжесть, связь с препаратом, исход). В случае СНЯ в течении 24 часов сообщите Спонсору исследования!"
              items={adverseDescVisit(setFormData, formData)}
            />
            <SelectBlock
              title="Решение врача-исследователя, что добровольца необходимо исключить в интересах самого добровольца"
              items={doctorDecisionVisit(setFormData, formData)}
            />
            <SelectBlock
              title="Отзыв добровольцем информированного согласия, отказ добровольца от участия в исследовании"
            ...
            />
            <SelectBlock
              title="Несоблюдение добровольцем требований протокола: нарушение графика визитов и процедур (пропуск или опоздание более чем на 1 час на сдачу биообразца 2 раза подряд или 3 раза за все исследование), ограничений по питанию и образу жизни, прием запрещенных лекарственных препаратов"
            ...
            />
            <SelectBlock
              title="Применение добровольцем или необходимость применения лекарственных препаратов, включая растительные лекарственные препараты и БАД, кроме препаратов исследования"
              items={medicationUseVisit(setFormData, formData)}
            />
            <SelectBlock
              title="Добровольцу требуется лечение в стационаре во время исследования"
            ...
            />
            <SelectBlock
              title="У добровольца возникло нежелательное явление, которое делает дальнейшее участие в исследовании нежелательным, невозможным или небезопасным для него по мнению исследователя"
              items={adverseEventVisit(setFormData, formData)}
            />
            <SelectBlock
              title="Положительный тест на содержание алкоголя в выдыхаемом воздухе"
            ...
            />
            <SelectBlock
              title="Положительный тест на содержание наркотических и сильнодействующих веществ в моче"
            ...
            />
            <SelectBlock
              title="Дегидратация из-за диареи, рвоты или другой причины в течение 24 часов до начала I или II периодов исследования"
            ...
            />
            <SelectBlock
              title="Рвота или диарея в течение 4 часов после приема препарата в любом периоде исследования (2 ожидаемых Tmax)"
            ...
            />
            <SelectBlock
              title="Технические трудности с отбором образцов крови, приведшие к пропуску 2 и более точек подряд"
            ...
            />
            <SelectBlock
              title="Доброволец продолжает участие в исследовании?"
