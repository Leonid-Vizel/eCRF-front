...
const ExactProtocolPage = () => {
    ...
    const handleSaveReasons = async () => {
        await axiosRequest.post('/subject/add', {center_id: parseInt(cookiesData.cookieCenterId), initials: initialsValue,
            number: screeningNumberValue, protocol_id: +params.protocolId})
                ...
                <div className="exact-left-sidebar" ref={sidebarRef}>
                    <div className="exact-left-sidebar-subjects">
                        ...
                        <div className="exact-left-sidebar-subjects-buttons">
                            <button className='exact-left-sidebar-button1'></button>
                            <button className='exact-left-sidebar-button2' onClick={() => handleAddProtocol()}></button>
                            <button className='exact-left-sidebar-button3'></button>
                        </div>
                    </div>
                    {selectedProtocol && (
                ...
                <div className="exact-main-content" ref={mainContentRef}>
                    ...
                    {selectedProtocol ? (
                        <div>
                            ...
                            <div className="exact-protocol-info">
                                <span>Name</span>
                                <span>Номер субъекта : {currentSubject}</span>
                                <span>Инициалы субъекта : {subjectsOfProtocol && subjectsOfProtocol[currentIndex]?.Initials}</span>
                            </div>
