...
const AdminMain = () => {
  ...
  const [showEditCenterModal, setShowEditCenterModal] = useState<boolean>(false);
  const [showDeleteCenterModal, setShowDeleteCenterModal] = useState<boolean>(false);
  ...
  const [showDeleteInsurance, setShowDeleteInsurance] = useState<boolean>(false);
