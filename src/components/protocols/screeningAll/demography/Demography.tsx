...
const Demography = ({data, index, anchorClassname, setIsColorRed, setIsOptionsColorRed, isOptionsColorRed}) => {
            ...
            <div className="section">
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.SexCondition.Color} element={
                                <select
                                name="sex"
                                value={demographics.sex}
                                onChange={handleDemographicsChange}
                            ...
                            >
                                ...
                                <option value={1}>Жен</option>
                            </select>} refProps={ref1} fieldName={'sex'} index={index}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        <div className="label-select-block">
                            <StateControl color={data && data?.RaceCondition.Color} element={
                                <select
                                    name="race"
                                    value={demographics.race}
                                    onChange={handleDemographicsChange}
                            ...
                            } refProps={ref2} fieldName={'race'} index={index}/>
                        </div>
                    </div>
                </label>
                <hr className="hr" />
                ...
                <label>
                    ...
                    <div className="label-select">
                        ...
                        />
                        <div className="label-select-block">
                            <StateControl color={data && data?.BirthDateCondition.Color} element={
                                <input
                                    type="date"
                                    name="birth_date"
                                    value={demographics.birth_date}
                                    ...
                                    className='exact-protocol-select'
                                />
                            } refProps={ref3} fieldName={'birth_date'} index={index}/>
                        </div>
                    </div>
                </label>
            </div>
